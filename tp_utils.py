...
def extract_column_widths(headerStr:str) -> list: return [x+1 for x in range(0, len(headerStr)) if headerStr[x] == ' ' and headerStr[x+1] != ' '] #todo: empty line issue?
...
def process_whitespaced_table(tableLines: list, headerWidths: list) -> list:
    ...
    for line in tableLines:
        ...
        parsedString = []
        if headerWidths[0] != 1: #TODO TEST (was 0)
