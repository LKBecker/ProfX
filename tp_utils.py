...
def process_whitespaced_table(tableLines: list, headerWidths: list) -> list:
    ...
    for line in tableLines:
        ...
        for counter in range(0, len(headerWidths)-1): parsedString.append(line[headerWidths[counter]:headerWidths[counter+1]].strip())
        parsedString.append( line[headerWidths[-1]:].strip() )
